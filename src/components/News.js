...
export class News extends Component {
    articles = [
        {
            ...
            "author": "Mugdha Kusray",
            "title": "23 Best Indian TV Shows And Movies Of 2023",
            "description": "You need to watch these if you haven't already!",
            "url": "https://www.buzzfeed.com/mugdhakusray1/23-best-indian-tv-shows-and-movies-of-2023",
            "urlToImage": "https://img.buzzfeed.com/buzzfeed-static/static/2023-12/19/15/enhanced/3066903f28d7/original-4865-1703000438-2.jpg?crop=1245:652;5,24%26downsize=1250:*",
            "publishedAt": "2024-09-11T08:22:20.8209588Z",
            "content": null
        },
        {
            "source": {
    ...
    {
        //console.log("cmd");
        let url = "https://newsapi.org/v2/everything?q=tesla&from=2024-08-13&sortBy=publishedAt&apiKey=2cc789d64d984f458a4fa08702a336b8";
    ...
    //     let url = `https://newsapi.org/v2/everything?q=tesla&from=2024-08-13&sortBy=publishedAt&apiKey=2cc789d64d984f458a4fa08702a336b8&page=${this.state.page - 1}&pageSize=10`;
    //     let data = await fetch(url);
    //     let parsedData = await data.json()
    //     this.setState({
    ...
    render() {
        return (
            <div className="container my-3">
                <h1 className="textCenter">SRA NEWS - Top Headlines</h1>
                <div className="row">
